...
public class DefaultMod implements
    ...
    private static final String AUTHOR = "Zacc & Gremious"; // And pretty soon - You!
    private static final String DESCRIPTION = "A test mod for Slay the Spire I started my own mod from, feat. the Default.";
