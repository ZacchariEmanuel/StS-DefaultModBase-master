...
public class Flagellation extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(Flagellation.class.getSimpleName());
    public static final String IMG = makeCardPath("Flagellation.png"); //Default IMG
    // Use if you have a png for this card //public static final String IMG = makeCardPath("Flagellation.png");
