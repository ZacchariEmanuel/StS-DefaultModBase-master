package testMod.cards.SplitCards;
...
public class StrengthDexPower extends AbstractDynamicCard {
    public static final String ID = DefaultMod.makeID(StrengthDexPower.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        stanceChoices.add(new StrengthPowerPower());
        stanceChoices.add(new DexPowerPower());
        if (this.upgraded) {
...
class StrengthPowerPower extends AbstractDynamicCard {
    ...
    public AbstractCard makeCopy() {
        AbstractCard card = new StrengthPowerPower();
        if (this.upgraded)
            card.upgrade();
        return card;
    }
...
class DexPowerPower extends AbstractDynamicCard {
    ...
    public AbstractCard makeCopy() {
        AbstractCard card = new DexPowerPower();
        if (this.upgraded)
            card.upgrade();
        return card;
    }
